    ...
    public class Startup
    {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("0.0.2", new OpenApiInfo
                    {
                        Version = "0.0.2",
                        Title = "TicTacToe API",
                        Description = "TicTacToe API (ASP.NET Core 3.0)",
                    ...
                    c.DocumentFilter<BasePathFilter>("/performantIT/TicTacToeAPI_Kseniia/0.0.2");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/0.0.2/swagger.json", "TicTacToe API");

                //TODO: Or alternatively use the original Swagger contract that's included in the static files
                // c.SwaggerEndpoint("/swagger-original.json", "TicTacToe API Original");
            });
